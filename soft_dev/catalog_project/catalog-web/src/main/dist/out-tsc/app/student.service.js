...
export var StudentService = (function () {
    ...
    StudentService.prototype.loginStudent = function (email,password) {
        // return this.getStudents()
        //     .then(students => students.find(student => student.id === id));
        var url = this.studentsUrl + "/" + id;
        console.log('blaaaaaaaa ');
...
//# sourceMappingURL=/home/radu/files/workspaces/workspace_2017/catalog4/catalog-web/src/main/webapp/app/teacher.service.js.map